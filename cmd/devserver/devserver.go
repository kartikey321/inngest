...
func action(ctx context.Context, cmd *cli.Command) error {
	...
	opts := devserver.StartOpts{
		...
		QueuePeekMin:          localconfig.GetIntValue(cmd, "queue-peek-min", devserver.DefaultQueuePeekMin),
		QueuePeekMax:          localconfig.GetIntValue(cmd, "queue-peek-max", devserver.DefaultQueuePeekMax),
		QueueMinWorkersFree:   localconfig.GetIntValue(cmd, "queue-min-workers-free", devserver.DefaultQueueMinWorkersFree),
		QueuePartitionLeaseMS: localconfig.GetIntValue(cmd, "queue-partition-lease-ms", devserver.DefaultQueuePartitionLeaseMS),
		DisableFifoFunctions:  localconfig.GetValue(cmd, "disable-fifo-functions", ""),
		DisableFifoAccounts:   localconfig.GetValue(cmd, "disable-fifo-accounts", ""),
